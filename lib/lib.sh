...
#                                                                                    #
# https://github.com/Rians-z-rex/pterodactyl-installer/blob/master/LICENSE #
#                                                                                    #
# This script is not associated with the official Pterodactyl Project.               #
# https://github.com/Rians-z-rex/pterodactyl-installer                     #
#                                                                                    #
######################################################################################
...
# download URLs
export PANEL_DL_URL="https://github.com/Rians-z-rex/panel/releases/latest/download/panel.tar.gz"
export WINGS_DL_BASE_URL="https://github.com/Rians-z-rex/wings/releases/latest/download/wings_linux_"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/Rians-z-rex/pterodactyl-installer"}
...
welcome() {
  ...
  output "https://github.com/Rians-z-rex/pterodactyl-installer"
  output ""
